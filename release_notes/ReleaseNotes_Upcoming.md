...
| [#7522](https://github.com/ISISComputingGroup/IBEX/issues/7522)  [#7539](https://github.com/ISISComputingGroup/IBEX/issues/7539) [#7546](https://github.com/ISISComputingGroup/IBEX/issues/7546)  | Major | TC/Beckhoff | Switch from using TcIOC to AdsDriver for easier integration of motion code. **note: existing beckhoff installs ie SANS2D guides will need to be re-configured** |
...
| [#7508](https://github.com/ISISComputingGroup/IBEX/issues/7508) | Minor | TC/Beckhoff | Flip limits and reported direction when commanded direction is changed |
