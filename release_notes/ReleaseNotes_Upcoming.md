...
|[#8456](https://github.com/ISISComputingGroup/IBEX/issues/8456)| Minor | Adds type stubs for user facing genie-python functions to improve how well Pyright reports type errors. |
