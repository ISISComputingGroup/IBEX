...
| [#7459](https://github.com/ISISComputingGroup/IBEX/issues/7459#issue-1433842900) | Minor | Get machine details function now looks up machines in INSTLIST PV to connect to right host name. |
